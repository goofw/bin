# This script was generated from '/mnt/build/src/ncurses-6.5/man/man_db.renames' by man/make_sed.sh.
# Do the TH lines
...
s/\<fB\(\\%\)\?adacurses6-config\\fP(1)/fB\\%adacurses6-config\\fP(1)/
s/\<fB\(\\%\)\?ncurses6-config\\fP(1)/fB\\%ncurses6-config\\fP(1)/
